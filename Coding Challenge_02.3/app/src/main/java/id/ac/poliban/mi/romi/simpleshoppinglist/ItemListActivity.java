package id.ac.poliban.mi.romi.simpleshoppinglist;
...
import id.ac.poliban.mi.romi.simpleshoppinglist.databinding.ActivityItemListBinding;

public class ItemListActivity extends AppCompatActivity {
    public final static String ITEM_TAG = "id.ac.poliban.mi.romi.simpleshoppinglist.EXTRA.ITEM";
